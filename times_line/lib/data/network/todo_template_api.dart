...
class TodoTemplateApi implements TodoTemplateRepository{
  ...
  @override
  Future<SimpleResult<TodoTaskTemplateSample, Error>> addTodoTemplate(TodoTaskTemplateSample template) async{
  ...
  @override
  Future<SimpleResult<QuerySnapshot<Map<String, dynamic>>, Error>> getTodoTemplateList(String uid) async{
  ...
  @override
  Future<SimpleResult<void, Error>> updateTemplate(TodoTaskTemplateSample template) async{
    return SimpleResult.success();
  }
