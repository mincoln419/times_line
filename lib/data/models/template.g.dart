...
const TemplateSchema = CollectionSchema(
  ...
  indexes: {},
  links: {},
  embeddedSchemas: {r'TemplateTask': TemplateTaskSchema},
...
int _templateEstimateSize(
  ...
  {
    final offsets = allOffsets[TemplateTask]!;
    for (var i = 0; i < object.tasks.length; i++) {
      final value = object.tasks[i];
      bytesCount += TemplateTaskSchema.estimateSize(value, offsets, allOffsets);
    }
  }
  return bytesCount;
}
...
void _templateSerialize(
  ...
  writer.writeObjectList<TemplateTask>(
    offsets[3],
    allOffsets,
    TemplateTaskSchema.serialize,
    object.tasks,
  );
...
Template _templateDeserialize(
  ...
  object.tasks = reader.readObjectList<TemplateTask>(
        offsets[3],
        TemplateTaskSchema.deserialize,
        allOffsets,
        TemplateTask(),
      ) ??
      [];
...
P _templateDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 3:
      return (reader.readObjectList<TemplateTask>(
            offset,
            TemplateTaskSchema.deserialize,
            allOffsets,
            TemplateTask(),
...
extension TemplateQueryFilter
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> tasksLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> tasksIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'tasks',
        0,
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> tasksIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'tasks',
        0,
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> tasksLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> tasksLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TemplateQueryObject
    on QueryBuilder<Template, Template, QFilterCondition> {
  QueryBuilder<Template, Template, QAfterFilterCondition> tasksElement(
      FilterQuery<TemplateTask> q) {
    return QueryBuilder.apply(this, (query) {
...
extension TemplateQueryProperty
  ...
  QueryBuilder<Template, List<TemplateTask>, QQueryOperations> tasksProperty() {
    return QueryBuilder.apply(this, (query) {
...
const TemplateTaskSchema = Schema(
  name: r'TemplateTask',
  id: 3980935786301392365,
  properties: {
    ...
    r'taskType': PropertySchema(
      ...
      name: r'taskType',
      type: IsarType.byte,
      enumMap: _TemplateTasktaskTypeEnumValueMap,
    )
  },
  estimateSize: _templateTaskEstimateSize,
  serialize: _templateTaskSerialize,
  deserialize: _templateTaskDeserialize,
  deserializeProp: _templateTaskDeserializeProp,
);

int _templateTaskEstimateSize(
  TemplateTask object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
...
TemplateTask _templateTaskDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = TemplateTask();
  object.content = reader.readString(offsets[0]);
  object.hour = reader.readLong(offsets[1]);
  object.taskType =
      _TemplateTasktaskTypeValueEnumMap[reader.readByteOrNull(offsets[2])] ??
          TaskType.spiritual;
  return object;
}

P _templateTaskDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
  ...
  switch (propertyId) {
    ...
    case 2:
      return (_TemplateTasktaskTypeValueEnumMap[
...
const _TemplateTasktaskTypeEnumValueMap = {
  'spiritual': 0,
  'intellectual': 1,
  'social': 2,
  'physical': 3,
...
const _TemplateTasktaskTypeValueEnumMap = {
...
extension TemplateTaskQueryFilter
    on QueryBuilder<TemplateTask, TemplateTask, QFilterCondition> {
  QueryBuilder<TemplateTask, TemplateTask, QAfterFilterCondition>
      contentEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<TemplateTask, TemplateTask, QAfterFilterCondition> hourEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'hour',
  ...
  QueryBuilder<TemplateTask, TemplateTask, QAfterFilterCondition> hourLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TemplateTask, TemplateTask, QAfterFilterCondition> hourBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<TemplateTask, TemplateTask, QAfterFilterCondition>
      taskTypeEqualTo(TaskType value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'taskType',
        value: value,
...
extension TemplateTaskQueryObject
    on QueryBuilder<TemplateTask, TemplateTask, QFilterCondition> {}
